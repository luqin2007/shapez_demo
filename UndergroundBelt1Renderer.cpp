                                             ...
                                             GameRenderer& renderer, const GameMap& map) const
{
	...
	auto& [u, v, w, h] = renderer.buildings_small["underground_belt_entry.png"];
...
{
	auto& [u, v, w, h] = renderer.buildings_small["underground_belt_entry_blue.png"];
	renderer.tex_drawer.tex(renderer.buildings_small);
...
void UndergroundBelt1Renderer::draw_icon(const float x, const float y, float size, GameRenderer& renderer) const
{
	...
	const auto& [u, v, w, h] = renderer.icons["underground_belt.png"];
