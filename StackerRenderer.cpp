                                    ...
                                    GameRenderer& renderer, const GameMap& map) const
{
	...
	auto& [u, v, w, h] = renderer.buildings_middle["stacker.png"];
...
{
	auto& [u, v, w, h] = renderer.buildings_middle["stacker_blue.png"];
	renderer.tex_drawer.tex(renderer.buildings_middle);
...
void StackerRenderer::draw_icon(const float x, const float y, float size, GameRenderer& renderer) const
{
	...
	const auto& [u, v, w, h] = renderer.icons["stacker.png"];
