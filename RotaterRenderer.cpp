                                    ...
                                    GameRenderer& renderer, const GameMap& map) const
{
	...
	auto& [u, v, w, h] = get_building_uv(renderer);
...
void RotaterRenderer::draw_icon(const float x, const float y, float size, GameRenderer& renderer) const
{
	...
	const auto& [u, v, w, h] = renderer.icons["rotater.png"];
...
const Rect& RotaterCWRenderer::get_building_uv(const GameRenderer& renderer) const
{
	return renderer.buildings_small["rotater.png"];
}

const Rect& RotaterCWRenderer::get_holding_uv(const GameRenderer& renderer) const
{
	return renderer.buildings_small["rotater_blue.png"];
}

const Rect& RotaterCCWRenderer::get_building_uv(const GameRenderer& renderer) const
{
	return renderer.buildings_small["rotater-ccw.png"];
}

const Rect& RotaterCCWRenderer::get_holding_uv(const GameRenderer& renderer) const
{
	return renderer.buildings_small["rotater-ccw_blue.png"];
}
