...
class BalancerRenderer final : public BuildingRenderer
{
public:
	...
	void draw_items_in_building(int row, int col, const BuildingContext& context,
	                            GameRenderer& renderer, const GameMap& map) const override
	{
	}
};
