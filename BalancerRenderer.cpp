                                     ...
                                     GameRenderer& renderer, const GameMap& map) const
{
	...
	auto& [u, v, w, h] = renderer.buildings_middle["balancer.png"];
...
{
	auto& [u, v, w, h] = renderer.buildings_middle["balancer_blue.png"];
	renderer.tex_drawer.tex(renderer.buildings_middle);
...
void BalancerRenderer::draw_icon(const float x, const float y, float size, GameRenderer& renderer) const
{
	...
	const auto& [u, v, w, h] = renderer.icons["balancer.png"];
